		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#rbx107clinicalresearcher-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rbx107clinicalresearcher-display": {
								"semanticObject": "rbx107clinicalresearcher",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rbx.107.clinicalresearcher",
									"url": sap.ui.require.toUrl("rbx/107/clinicalresearcher")
								}
							}
						}
					}
